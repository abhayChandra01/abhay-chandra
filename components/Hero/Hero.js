...
export default function Hero() {
    ...
    return (
        <div className='justify-center px-[6vw] pb-20 min-h-screen xs:flex-wrap md:flex'>
            <div className='bg-[#251170] w-full min-h-[55rem] flex justify-center items-center'>
                <div className='flex flex-col'>
                    ...
                    <h1 className='md:text-[4vw] text-[8vw] text-center font-bold text-[#e8e8e8] font-sans'>
                        Abhay Chandra
                    </h1>
